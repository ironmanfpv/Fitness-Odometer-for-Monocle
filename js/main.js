...
export function onDisconnect() {
    ...
    document.getElementById('connectBtn').style.visibility = 'visible';       //show connectBtn
    document.getElementById('DisconnectBtn').style.visibility = 'hidden';     //hide DisconnectBtn
