...
export function isConnected() {
    ...
    if (device && device.gatt.connected) {
        document.getElementById('connectBtn').style.visibility = 'hidden';         //hide connectBtn
        document.getElementById('DisconnectBtn').style.visibility = 'visible';     //show DisconnectBtn
